...
<body>
  <div id="wrap">
    ...
    <div id="sidebar" style="background-color: transparent;">
      ...
      <!-- navigation menu -->
      <ul id="navigation">
        <li><a href="teacher/login.php">Instructor</a></li>
      </ul>
      ...
      <div class="page" id="contact">
        ...
        <div class="page_content">
          <fieldset id="contact_form">
            <div id="msgs"> </div>
            <form id="cform" name="cform" method="post" action="index.php">
              <input type="text"  name="uname" placeholder ="User Name" style="width: 35%; margin-left: 30%;" required>
          ...
          <div class="clear"> 
            ...
            if (isset($_POST['login'])) {
              ...
              $sql = "SELECT * FROM DEPT_ADMIN WHERE USERNAME ='$username' AND PASSWORD = '$password'";
