...
<div id="wrap">
  ...
  <div id="container">
    ...
    <div class="page" id="contact">
      <!-- page contact -->
    <h3 class="page_title" align="center">List of Instructors</h3>
      ...
      <table width="100%">
        ...
        include "includes/connect.php"; 
          $sql = "SELECT * FROM INSTRUCTOR where department = '$dept' ";
        ...
        <ul id="navigation">
          <li><a href="add_instructor.php?dept=<?php echo $dept ?>">New Instructor</a></li>
        </ul>
      </div>
    </div>
    <div class="footer">
